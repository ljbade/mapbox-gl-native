...
void LineBucket::render(Painter& painter, const StyleClass &style_class, const std::string& layer_name, const Tile::ID& id) {
    painter.renderLine(*this, style_class, layer_name, id);
}
