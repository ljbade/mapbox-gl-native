...
void RasterBucket::render(Painter &painter, const StyleClass &style_class, const std::string &layer_name, const Tile::ID &id) {
    painter.renderRaster(*this, style_class, layer_name, id);
}
